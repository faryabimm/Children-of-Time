...
/**
 * public static void performEffects(List<Effects> currentUserCustomEffects, @NotNull Warrior performer, @Nullable Warrior[] target_s, @Nullable Warrior... implicitTargets){
 * Iterator<Effects> itr = currentUserCustomEffects.iterator();
