...
public class Bouncer extends JPanel implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        f.setSize(ChildrenOfTime.PREFERRED_WIDTH, ChildrenOfTime.PREFERRED_HEIGHT);
...
//        f.add(controls, BorderLayout.NORTH);
    ...
    // Tweakable variables
    private boolean mAntialiasing = true, mGradient = false, mOutline = false;

    private boolean mTransform = true, mDotted = false, mAxes = false, mClip = true;
    ...
    protected void render() {
        ...
        if (g != null) {
            ...
            if (checkImage(d)) {
                ...
                imageGraphics.setColor(ChildrenOfTime.GREY);
